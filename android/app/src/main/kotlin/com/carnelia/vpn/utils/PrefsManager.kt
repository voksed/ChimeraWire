...
object PrefsManager {
    ...
    // Black Wall
    fun getBlackWallEnabled(context: Context): Boolean =
        getPrefs(context).getBoolean("black_wall_enabled", false)

    fun setBlackWallEnabled(context: Context, enabled: Boolean) =
        getPrefs(context).edit().putBoolean("black_wall_enabled", enabled).apply()

    fun getBlackWallLevel(context: Context): String =
        getPrefs(context).getString("black_wall_level", "GHOST") ?: "GHOST"
